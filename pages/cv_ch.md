...
<a href="https://plus.google.com/share?url={{ site.url }}/cv_ch"  class="social-icons" target="_blank" title="Share on Google+"> <i class="fa fa-google-plus"></i></a>
<a href="{{ site.owner.linkedin }}" class="social-icons" title="LinkedIn profile"><i class="fa fa-linkedin"></i></a>
<a href="{{ site.url }}/files/卢少锋中文简历.pdf" class="social-icons" title="Printer friendly format"><i class="fa fa-print"></i></a>
</span>
...
<iframe src="{{ site.url }}/files/卢少锋中文简历.pdf" width="100%" style="height: 100vh;"></iframe>

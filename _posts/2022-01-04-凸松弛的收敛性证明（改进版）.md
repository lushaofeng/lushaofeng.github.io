...
\begin{align}
\label{eq:beta_ul_1}
&0.5M（\beta_i-\beta_{i-1}）\\
&+(A+Bv_{ave,i}+C\beta_i)\Delta d+Mg\Delta H_i \leq 0\nonumber\\
&(0.5M+C\Delta d)\beta_i \nonumber\\ 
&\leq 0.5\beta_{i-1}-(A+Bv_{ave,i})\Delta d-Mg\Delta H_i\nonumber\\
&\beta_i \leq \frac{0.5\beta_{i-1}-(A+Bv_{ave,i})\Delta d\nonumber\\
&-Mg\Delta H_i}{0.5M+C\Delta d}\nonumber
\end{align}
$$
...
\begin{align}
\label{eq:beta_ul_2}
0.5M\beta_i &\leq 0.5M\beta_{i+1}+(A+Bv_{ave,i}+C\beta_{i+1})\Delta d\\
+Mg\Delta H_i\nonumber\\
\beta_i &\leq \frac{0.5M\beta_{i+1}+(A+Bv_{ave,i}+C\beta_{i+1})\Delta d\nonumber\\
+Mg\Delta H_i}{0.5M}\nonumber
\end{align}
$$
